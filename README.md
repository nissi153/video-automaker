...
## 방법 A. EXE 파일로 바로 실행 (비개발자 권장)

별도 설치 없이 `dist\video-automaker\video-automaker.exe` 파일을 더블클릭하면 실행됩니다.

> **주의:** EXE 파일 하나만 복사하면 안 됩니다. `dist\video-automaker` **폴더 전체**를 복사해야 합니다.

---

## 방법 B. Python으로 직접 실행 (개발자 / 소스 수정 시)
